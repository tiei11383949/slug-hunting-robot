...
def generate_launch_description():
    ...
    bot_demos = get_package_share_directory('bot')
    exp_demos = get_package_share_directory('explore_lite')
    # LOAD PARAMETERS FROM YAML FILES
    config_bt_nav     = PathJoinSubstitution([pkg_demos, 'bot_bt_navigator.yaml'])
    config_planner    = PathJoinSubstitution([pkg_demos, 'bot_planner.yaml'])
    config_controller = PathJoinSubstitution([pkg_demos, 'bot_controller.yaml'])
    config_behaviour  = PathJoinSubstitution([pkg_demos, 'bot_behaviour.yaml']) 
    ...
    PythonLaunchDescriptionSource([bot_demos, '/launch', '/display.launch.py']),
